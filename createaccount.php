    ...
    <body>
        ...
        <main>
            ...
            <div class="sect" id="content">
                ...
                <form onsubmit=validateAccount() action="validateAccount.php" method="post" name="accountForm">
                    <p>
                ...
                <p>Username can only be composed of letters and numbers</p>
                <p>Password can only be composed of letters and numbers, must contain a number, a letter, and must be at least 4 characters long.</p>
                </div>
            </div>
        </main>
